...
# Methods
# (1)-initaccept a list words as argument and assign it to the corresponding attribute
...
# (4) words_of_length: accept a positive integer length as argument and return a list of all the words in the list
# Words that have a length equal to length
# (5) words_start_with: accept a character char as argument and return the list of all the words in words that start
# with char
...
# (1) For those methods where you are expected to returna list of words, make sure that the words in the returned list
...
# (3) You do not have to accept input from the user or print output to the console. You just have to define the class based
